...
class Meal:
    ...
    def __post_init__(self):
         """Post-initialization checks for Meal attributes.
        Raises ValueError if price is negative or difficulty is invalid"""
        if self.price < 0:
...
def create_meal(meal: str, cuisine: str, price: float, difficulty: str) -> None:
    ...
    Raises:
        ...
        sqlite3.IntegrityError: If the meal already exists.
...
def get_leaderboard(sort_by: str="wins") -> dict[str, Any]:
    """Retrieve the meal leaderboard sorted by the specified attribute.
    Args:
        sort_by (str): The attribute to sort by ('wins' or 'win_pct'). Defaults to 'wins'.
    Returns:
        dict[str, Any]: A list of meals with their statistics sorted by the specified attribute.
    Raises:
...
def update_meal_stats(meal_id: int, result: str) -> None:
    """Update the battle statistics of a meal.
    Args:

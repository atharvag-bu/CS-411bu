...
#Using the playlist test file sample to modify this import line
...
def test_get_random(mock_random_org):
    ...
    # Ensuring that the correct URL was called
    #Updating the URL correctly
...
#implementing all functions as identified and understood from playlist sample

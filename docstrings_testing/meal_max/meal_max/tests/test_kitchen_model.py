...
#Adding the kitchen_model to all of the methods
...
def mock_cursor(mocker):
    ...
    #Updating the path as per our meal max model
...
def test_create_meal_invalid_difficulty():
    # Attempt to create a meal with difficulty = 'LOW'
    difficulty = 'LOW'
    with pytest.raises(ValueError, match=f"Invalid difficulty level: {difficulty}. Must be 'LOW', 'MED', or 'HIGH'."):
        create_meal(meal="Meal Name", cuisine="Cuisine Name", price=3.99, difficulty='HIGH')
...
def test_create_meal_invalid_price():
    ...
    with pytest.raises(ValueError, match=f"Invalid price: {price}. Price must be a positive number."):
        create_meal(meal="Meal Name", cuisine="Cuisine Name", price=-5, difficulty='LOW')
...
def test_get_leaderboard(mock_cursor):
    ...
    mock_cursor.fetchall.return_value = [
        (1, "Meal A", "Cuisine A", 1.88, "LOW", 10, 3, 0.3, False),
        (2, "Meal B", "Cuisine B", 5.6, "MED", 10, 1, 0.1, False),
        (3, "Meal C", "Cuisine C", 10.12, "HIGH", 10, 2, 0.2, False)
    ]
    ...
    expected_result = [
        {"id": 1, "meal": "Meal A", "cuisine": "Cuisine A", "price": 1.88, "difficulty": "LOW", "battles": 10, "wins": 3, "win_pct": 30},
        {"id": 2, "meal": "Meal B", "cuisine": "Cuisine B", "price": 5.6, "difficulty": "MED", "battles": 10, "wins": 1, "win_pct": 10},
        {"id": 3, "meal": "Meal C", "cuisine": "Cuisine C", "price": 10.12, "difficulty": "HIGH", "battles": 10, "wins": 2, "win_pct": 20}
    ]
...
def test_get_leaderboard_ordered_by_win_pct(mock_cursor):
    ...
    # Simulate that there are multiple meals in the database
    mock_cursor.fetchall.return_value = [
        (2, "Meal B", "Cuisine B", 1.0, "MED", 10, 4, 0.4),
        (1, "Meal A", "Cuisine A", 1.21, "LOW", 20, 2, 0.1),
        (3, "Meal C", "Cuisine C", 7.50, "HIGH", 10, 5, 0.5)
    ]
    ...
    expected_result = [
        {"id": 2, "meal": "Meal B", "cuisine": "Cuisine B", "price": 1.0, "difficulty": "MED", "battles": 10, "wins": 4, "win_pct": 40},
        {"id": 1, "meal": "Meal A", "cuisine": "Cuisine A", "price": 1.21, "difficulty": "LOW", "battles": 20, "wins": 2, "win_pct": 10},
        {"id": 3, "meal": "Meal C", "cuisine": "Cuisine C", "price": 7.50, "difficulty": "HIGH", "battles": 10, "wins": 5, "win_pct": 50}
    ]
...
def test_get_meal_by_id(mock_cursor):
    # Simulate that the meal exists (id = 1)
    mock_cursor.fetchone.return_value = (1, "Meal Name", "Cuisine Name", 0.1, 'MED', False)

    # Call the function and check the result
    result = get_meal_by_id(1)

    # Expected result based on the simulated fetchone return value
    expected_result = Meal(1, "Meal Name", "Cuisine Name", 0.2, 'MED')
...
def test_get_meal_by_name(mock_cursor):
    ...
    # Expected result based on the simulated fetchone return value
    expected_result = Meal(1, "Meal Name", "Cuisine Name", 0.1, 'MED')
